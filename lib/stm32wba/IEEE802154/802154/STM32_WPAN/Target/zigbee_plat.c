...
{
  // -- Init random HW driver -- Driver already initialized in bleplat.c
}
...
{
  // -- Generate new Random numbers -- Driver already generate random numbers.
}
...
{
  LINKLAYER_PLAT_GetRNG(pValue, cNumberOfBytes);
}
